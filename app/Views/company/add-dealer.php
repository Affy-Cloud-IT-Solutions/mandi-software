    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row">
                ...
                <form action="<?php echo base_url(); ?>dealer-report-save" class="form-inputs" method="post">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 my-2">
                                ...
                                <select class="py-2 w-100" name="crate_brand[]" id="crate_for" multiple required onchange="addCrateBrand('company-form','ajax_dealer_form')">
...
<div class="modal fade" id="addBrand" tabindex="-1" role="dialog" aria-labelledby="addBrandLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() ?>/save-crate" class="form-inputs" method="post">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 my-2">
