                            ...
                            <li class="nav-item dropdown">
                                ...
                                <a href="javascript:void(0)" class="d-flex align-items-center gap-2 dropdown-item">
                                    ...
                                    <p class="mb-0 fs-3">My Task</p>
                                        ...
                                        <a href="<?= base_url('profile') ?>" class="btn btn-outline-success mx-3 mt-2 d-block">Profile</a>
                                        <a href="<?= base_url('company/logout') ?>" class="btn btn-outline-primary mx-3 mt-2 d-block">Logout</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
